...
**Note:** The credentials of the admin users are set from the \`.env\` file.`,
        },
        servers: [
            {
                ...
                User: {
                    ...
                    properties: {
                        ...
                        blogPostReports: {
                            type: "array",
                            items: {
                                $ref: "#/components/schemas/BlogPostReport",
                            },
                        },
                        blogPostVotes: {
                            type: "array",
                            items: {
                                $ref: "#/components/schemas/BlogPostVote",
                            },
                        },
                        commentReports: {
                            type: "array",
                ...
                CodeTemplate: {
                    ...
                    properties: {
                        ...
                        tags: {
                            type: "array",
                            items: {
                                $ref: "#/components/schemas/CodeTemplateTag",
                            },
                        },
                        user: { $ref: "#/components/schemas/User" },
                    },
